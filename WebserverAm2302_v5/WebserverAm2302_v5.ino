...
// defines
#define HISTSIZE            24  // History size in number of samples
#define BMP085_ADDRESS    0x77  // I2C address of BMP085
#define DHT22_PIN            6  // DHT22 connected on pin 6
#define DHT22_PIN1           6  // DHT22-S1 connected on pin 6
#define DHT22_PIN2           5  // DHT22-S2 connected on pin 5
#define DHT22_PIN3           7  // DHT22-S3 connected on pin 7
#define DHT22_PIN4           8  // DHT22-S4 connected on pin 8
...
#define NOTPRESENT        9999  // code for sensor not present
...
// bmp085 vars, calibration values
int ac1,ac2,ac3; 
...
void setup() {  
   ...
   thist=0;
   tcheck=0;
   t1 = t2 = t3 = t4 = t5 = NOTPRESENT;
   h1 = h2 = h3 = h4 = p5 = NOTPRESENT;
   ...
   // DHT22 test
   s1 = checkDHT22(DHT22_PIN1);
   if (s1) Serial.println(F("DHT22-S1 OK")); else Serial.println(F("DHT22-S1 ERROR")); 
   s2 = checkDHT22(DHT22_PIN2);
   if (s2) Serial.println(F("DHT22-S2 OK")); else Serial.println(F("DHT22-S2 ERROR")); 
   s3 = checkDHT22(DHT22_PIN3);
   if (s3) Serial.println(F("DHT22-S3 OK")); else Serial.println(F("DHT22-S3 ERROR")); 
   s4 = checkDHT22(DHT22_PIN4);
   if (s4) Serial.println(F("DHT22-S4 OK")); else Serial.println(F("DHT22-S4 ERROR"));
   s5 = checkBMP085();
   if (s5) Serial.println(F("BMP085-S5 OK")); else Serial.println(F("BMP085-S5 ERROR"));
      
   // BMP085 calibration
   if (s5) bmp085Calibration();
...
boolean checkDHT22(int dht22pin) {
